...
<head>
  ...
  <title>8LS-Admin - FASHION</title>
  <!-- Custom fonts for this template-->

  <link href="/8letset/webroot/font/Font Awesome/css/all.min.css" rel="stylesheet" type="text/css">
  ...
  <script src="/8letset/webroot/jquery/jquery.js"></script>
<?php 
      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="?action=danhmuc&view=suadm">Xóa</a> 
