...
<div class="container-fluid">
	<div class=" alert alert-primary">
	  <h4 class="page-title">
	    ...
	    </span> ADMIN - 8LS_FASHION &#160;<i class="fas fa-chevron-right" style="font-size: 18px"></i>&#160; Nhân Viên</h4>
	</div><br>
	<div class="card">
		<div class="card-body">
			...
			<!-- <a href="?action=nhanvien&view=sua"><button class="btn btn-info" type="button">Sửa</button></a> -->
			</div>
		</div>
