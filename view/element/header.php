...
<html>
<head>
  <title>8LETSET - THƯƠNG HIỆU THỜI TRANG</title>
  <meta charset="utf-8">
	...
	<div id="page">
		<nav class="colorlib-nav" role="navigation">
			<div class="top-menu">
                ...
                <a href="?view">
					<!-- thay logo -->
                  <img class="logo-header" src="webroot/image/logo/8LETSET_clo(2).png" alt="">
                </a>
              </div>
						</div>
						...
						<div class="col-sm-8 offset-sm-2 text-center">
							<div class="row">
								<div class="owl-carousel2">
									...
									<div class="item">
										<div class="col">
											<h3><a href="#">Hãy tìm sản phẩm mà bạn mong muốn</a></h3>
										</div>
									</div>
								</div>
							</div>
